  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (id && id !== 'new') {
        ...
        setTimeout(() => setSuccessMessage(null), 3000);
        navigate(`/report-templates/${newTemplate.id}/edit`, { replace: true });
      }
    } catch {
      ...
      <div className="bg-background border-b px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button
            ...
            className="p-2 hover:bg-linear-to-br from-primary to-accent ease-in-out transition-all cursor-pointer rounded-lg"
          >
                ...
                {header.enabled && (
                  <>
                    ...
                    <div className='space-y-2'>
                      ...
                      className="w-full flex items-center justify-center gap-2 px-3 py-2 border rounded-lg hover:bg-gray-50 text-sm cursor-pointer"
                    >

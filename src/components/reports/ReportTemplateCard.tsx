...
export const ReportTemplateCard: React.FC<ReportTemplateCardProps> = ({
    ...
    const canGenerate = template.data_source && template.config.columns.length > 0;
    ...
    }, [template.data_source, template.config.columns, filters, fromDate, toDate]);
            ...
            <div className="p-5 border-b border-[hsl(var(--border))] bg-gradient-to-br from-transparent to-[hsl(var(--muted)/0.2)]">
                <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                        <div className={cn("p-2.5 rounded-xl shadow-sm transition-transform group-hover:scale-110 duration-300", sourceInfo.color)}>
            ...
            <div className="p-5 space-y-5 flex-1 bg-gradient-to-b from-transparent to-[hsl(var(--muted)/0.1)]">
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                        <label htmlFor={`from-${template.id}`} className="text-[11px] font-bold text-[hsl(var(--muted-foreground))] uppercase tracking-wider ml-1">
                            {t('common.fromDate')}
                        </label>
                    ...
                    <div className="space-y-1.5">
                        <label htmlFor={`to-${template.id}`} className="text-[11px] font-bold text-[hsl(var(--muted-foreground))] uppercase tracking-wider ml-1">
                            {t('common.toDate')}
                        </label>
                        <div className="relative group/input">
                            <input
                ...
                <div className="space-y-3">
                    ...
                    >
                        <div className="flex items-center gap-2 text-xs font-bold text-[hsl(var(--foreground))] uppercase tracking-wider">
                            <ChevronDown className={cn("w-4 h-4 transition-transform duration-300 text-[hsl(var(--primary))]", showFilters && "rotate-180")} />
                            {t('reports.filters')}
                            {filters.length > 0 && <span className="bg-[hsl(var(--primary))] text-white px-2 py-0.5 rounded-full text-[10px] ml-1">{filters.length}</span>}
                        </div>
                ...
                <div className='flex gap-3 w-full pt-2'>
                    <Button
                        ...
                        size="sm"
                        leftIcon={!isGenerating && <Play className="w-4 h-4 fill-current" />}
                    >
                            ...
                            <div className="px-6 py-4 bg-[hsl(var(--muted)/0.3)] border-b border-[hsl(var(--border))] flex items-center justify-between gap-4">
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="px-3 py-1 rounded-full bg-[hsl(var(--background))] border border-[hsl(var(--border))] text-xs font-bold">
                                        {previewData.length.toLocaleString()} <span className="text-[hsl(var(--muted-foreground))] font-medium">RECORDS FOUND</span>
                                    </div>
